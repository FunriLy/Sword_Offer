package com.qg.funrily.offer32;
...
public class Test32 {
    /*
    参考资料：https://github.com/Wang-Jun-Chao/coding-interviews/blob/master/src/Test32.java
     */
    ...
    public static void main(String[] args) {
        ...
        int result1 = numberOf1Between1AndN(2222222);
        long end1 = System.currentTimeMillis();
        System.out.println("运行时间：" + (end1-start1) + ", 运行结果：" + result1);

        long start2 = System.currentTimeMillis();
        int result2 = numberOf1Between1AndN2(2222222);
        long end2 = System.currentTimeMillis();
        System.out.println("运行时间：" + (end2-start2) + ", 运行结果："+ result2);
    }
}
